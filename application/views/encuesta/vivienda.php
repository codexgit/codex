                                                                        ...
                                                                        <div class="form-body">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Tenencia de la Vivienda -->
                                                                                    <div class="form-group <?php if (form_error('sel_tenencia') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Tenencia del Sitio -->
                                                                                    <div class="form-group <?php if (form_error('sel_sitio') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Subsidio Habitacional -->
                                                                                    <div class="form-group <?php if (form_error('sel_post_subsidio') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Libreta de Ahorros -->
                                                                                    <div class="form-group <?php if (form_error('sel_libreta') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Principal ocupante -->
                                                                                    <div class="form-group <?php if (form_error('sel_fam_ocupante') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-3"> <!-- Número de personas -->
                                                                                    <div class="form-group <?php if (form_error('txt_num_personas') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-3"> <!-- Número de dormitorios -->
                                                                                    <div class="form-group <?php if (form_error('txt_dormitorios') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Agua -->
                                                                                    <div class="form-group <?php if (form_error('sel_prov_agua') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Subsidio Agua -->
                                                                                    <div class="form-group <?php if (form_error('sel_sub_agua') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Energía eléctrica -->
                                                                                    <div class="form-group <?php if (form_error('sel_ener_electrica') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Eliminación de excretas -->
                                                                                    <div class="form-group <?php if (form_error('sel_elim_excretas') != ""){echo "has-error";} ?>">
                                                                                        <label class="control-label">¿Cuál es el Sistema de Energía eléctrica de la vivienda? <span class="required" aria-required="true"> * </span></label>
                                                                                        <br/><br/>
                                                                                        <?php
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Registro Social de hogares -->
                                                                                    <div class="form-group <?php if (form_error('sel_reg_hogares') != ""){echo "has-error";} ?>">
                                                                                        <label class="control-label">¿Tiene Subsidio de Agua Potable? <span class="required" aria-required="true"> * </span></label>
                                                                                        <br/><br/>
                                                                                        <?php
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Tramo grupo familiar -->
                                                                                    <div class="form-group <?php if (form_error('sel_tramo_grupo') != ""){echo "has-error";} ?>">
                                                                                        <label class="control-label">¿Cuál es el Sistema de Energía eléctrica de la vivienda? <span class="required" aria-required="true"> * </span></label>
                                                                                        <br/><br/>
                                                                                        <?php
