                                                                ...
                                                                <div class="portlet-body form">
																   ...
																   <!-- BEGIN FORM-->
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        echo form_open('encuesta/familia/'.$idencuesta.'/'.$integrante, $attributes);
                                                                    ?>
                                                                        <div class="form-body">
                                                                            <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6"> <!-- Apellido Paterno -->
                                                                                    <div class="form-group <?php if (form_error('txt_apellido_p') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-6"> <!-- Apellido Materno -->
                                                                                    <div class="form-group <?php if (form_error('txt_apellido_m') != ""){echo "has-error";} ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4"> <!-- Fecha Nacimiento -->
                                                                                    <div class="form-group <?php if (form_error('txt_fec_nacimiento') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Género -->
                                                                                    <div class="form-group <?php if (form_error('sel_genero') != ""){echo "has-error";} ?>">
                                                                                ...
                                                                                <div class="col-md-4"> <!-- Nacionalidad -->
                                                                                    <div class="form-group <?php if (form_error('sel_nac_chilena') != ""){echo "has-error";} ?>">
                                                                        ...
                                                                        <div class="form-actions right">
                                                                            ...
                                                                            <a href="<?php echo site_url('encuesta/vivienda/'); ?>" class="btn default" role="button">Volver</a>
