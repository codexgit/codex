                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="row list-separated">
                                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                                    ...
                                                                    <div class="uppercase font-hg font-red-flamingo"> 10
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                                    <div class="font-grey-mint font-sm"> Revisadas </div>
                                                                    <div class="uppercase font-hg theme-font"> 5
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                                    <div class="font-grey-mint font-sm"> Enviadas </div>
                                                                    <div class="uppercase font-hg font-purple"> 3
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                                    <div class="font-grey-mint font-sm"> Guardadas </div>
                                                                    <div class="uppercase font-hg font-blue-sharp"> 2
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <div class="table-scrollable table-scrollable-borderless">
                                                                <table class="table table-hover table-light">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Filial Número 1</a>
                                                                        </td>
                                                                        <td> 20 </td>
                                                                        <td> 8 </td>
                                                                        <td> 12 </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Filial Número 5</a>
                                                                        </td>
                                                                        <td> 17 </td>
                                                                        <td> 3 </td>
                                                                        <td> 14 </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Filial Número 6</a>
                                                                        </td>
                                                                        <td> 15 </td>
                                                                        <td> 10 </td>
                                                                        <td> 5 </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;" class="primary-link">Filial Número 10</a>
                                                                        </td>
                                                                        <td> 10 </td>
                                                                        <td> 2 </td>
                                                                        <td> 8 </td>
