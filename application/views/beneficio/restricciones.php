                                                    ...
                                                    <div class="portlet box red">
                                                        ...
                                                        <div class="portlet-body form">
                                                            ...
                                                            <div class="form-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 ">
                                                                        <div class="form-group <?php if (form_error('sel_tipo') != ""){echo "has-error";} ?>">
																	...
																	<div class="col-md-6">
																		<div class="form-group <?php if (form_error('sel_campo') != ""){echo "has-error";} ?>">
																	...
																	<div class="col-md-6">
																		<div class="form-group <?php if (form_error('txt_valor') != ""){echo "has-error";} ?>">
																	...
																	<div class="col-md-6">
																		<div class="form-group <?php if (form_error('sel_opcion') != ""){echo "has-error";} ?>">
																	...
																	<div class="col-md-6">
																		<div class="form-group <?php if (form_error('txt_grupo') != ""){echo "has-error";} ?>">
