                                            ...
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    ...
                                                    ?>">
                                                        ...
                                                        <!--<input type="text" name="txt_f_ini_v" id="txt_f_ini_v" class="form-control" placeholder="dd-mm-aaaa" value="<?php echo $f_ini_v; ?>" >-->
                                                ...
                                                <div class="col-md-6 ">
                                                    ...
                                                    ?>">
                                                        ...
                                                        <!--<input type="text" name="txt_f_fin_v" id="txt_f_fin_v" class="form-control" placeholder="dd-mm-aaaa" value="<?php echo $f_fin_v; ?>">-->
                                                        <!-- INICIO DEL CALENDARIO -->
                                                        <div class='input-group date datepicker' >
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    ...
                                                    ?>">
                                                        ...
                                                        <!--<input type="text" name="txt_f_ini_p" id="txt_f_ini_p" class="form-control" placeholder="dd-mm-aaaa" value="<?php echo $f_ini_p; ?>">-->
                                                        <!-- INICIO DEL CALENDARIO -->
                                                        <div class='input-group date datepicker' >
                                                ...
                                                <div class="col-md-6 ">
                                                    ...
                                                    ?>">
                                                        ...
                                                        <!--<input type="text" name="txt_f_fin_p" id="txt_f_fin_p" class="form-control" placeholder="dd-mm-aaaa" value="<?php echo $f_fin_p; ?>">-->
                                                        <!-- INICIO DEL CALENDARIO -->
                                                        <div class='input-group date datepicker'>
